...
export type DraftlyAttachmentEditorView = {
  state: {
    doc: {
      length: number;
      toString(): string;
...
function findMarkerRange(view: DraftlyAttachmentEditorView, taskId: string): { from: number; to: number } | null {
...
export async function uploadAttachmentFile(
  view: DraftlyAttachmentEditorView,
  file: File,
