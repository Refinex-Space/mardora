...
function appendLinkAction(
  ...
  button.className = danger
    ? "cm-draftly-selection-toolbar-link-button cm-draftly-selection-toolbar-link-button-danger"
    : "cm-draftly-selection-toolbar-link-button";
  button.setAttribute("aria-label", label);
  const svg = createDraftlyIcon(iconName);
