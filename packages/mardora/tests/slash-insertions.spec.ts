...
import { hasMardoraIcon } from "../src/editor/icons";
import type { MardoraSlashCommandContext } from "../src/editor/slash";
...
describe("defaultSlashCommands", () => {
  ...
  it("uses built-in icon identifiers for the default commands", () => {
    ...
    expect(defaultSlashCommands.every((command) => hasMardoraIcon(command.icon))).toBe(true);
  });
  ...
  it("inserts callout templates with the cursor on the content line", () => {
    ...
    } as unknown as MardoraSlashCommandContext;
