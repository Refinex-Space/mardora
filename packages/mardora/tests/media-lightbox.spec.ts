...
describe("openMediaLightbox", () => {
  it("renders image content in a dismissible dialog", () => {
    ...
    expect(fakeDocument.body.querySelector(".cm-mardora-media-lightbox")).not.toBeNull();
    ...
    expect(fakeDocument.body.querySelector(".cm-mardora-media-lightbox")).toBeNull();
