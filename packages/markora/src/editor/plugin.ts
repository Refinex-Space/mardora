...
import { MarkoraConfig } from "./markora";
...
/**
 * Abstract base class for all markora plugins
 *
 ...
 */
export abstract class MarkoraPlugin {
  ...
  /**
   * Called when plugin is registered with markora
 ...
 * Extends MarkoraPlugin with decoration-focused defaults
 */
export abstract class DecorationPlugin extends MarkoraPlugin {
  /**
 ...
 * Extends MarkoraPlugin with syntax-focused requirements
 */
export abstract class SyntaxPlugin extends MarkoraPlugin {
  /**
