...
/**
 * Base theme for markora styling
 * Note: Layout styles are scoped under .cm-markora which is added by the view plugin
 */
export const markoraBaseTheme = EditorView.theme({
  ...
  "&.cm-markora .cm-content .cm-line": {
    paddingInline: 0,
  },

  "&.cm-markora .cm-content .cm-widgetBuffer": {
