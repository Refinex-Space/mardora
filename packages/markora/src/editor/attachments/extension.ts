...
export type MarkoraAttachmentEditorView = {
  state: {
    doc: {
      length: number;
      toString(): string;
...
function findMarkerRange(view: MarkoraAttachmentEditorView, taskId: string): { from: number; to: number } | null {
...
export async function uploadAttachmentFile(
  view: MarkoraAttachmentEditorView,
  file: File,
