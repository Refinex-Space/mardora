...
// Plugin collections
import { MarkoraPlugin } from "../editor/plugin";
 ...
 */
const essentialPlugins: MarkoraPlugin[] = [
  new ParagraphPlugin(),
  new HeadingPlugin(),
  new InlinePlugin(),
  new LinkPlugin(),
 ...
 * All plugins
 *
 * This is the set of all plugins available with markora
 */
const allPlugins: MarkoraPlugin[] = [...essentialPlugins];
