...
const imageMarkDecorations = {
  "image-block": Decoration.line({ class: "cm-markora-image-block" }),
  "image-marker": Decoration.mark({ class: "cm-markora-image-marker" }),
  "image-alt": Decoration.mark({ class: "cm-markora-image-alt" }),
  "image-url": Decoration.mark({ class: "cm-markora-image-url" }),
...
class ImageWidget extends WidgetType {
  ...
  toDOM(view: EditorView) {
    ...
    img.className = "cm-markora-image";
    img.src = this.url;
    img.alt = this.alt;
    ...
    img.onerror = () => {
      ...
      errorSpan.className = "cm-markora-image-error";
    ...
    if (this.title) {
      ...
      figcaption.className = "cm-markora-image-caption";
...
const imageTheme = createTheme({
  default: {
    ...
    // Image markers (! [ ] ( ))
    ".cm-markora-image-marker": {
      color: "#6a737d",
      fontFamily: "var(--font-jetbrains-mono, monospace)",
    },

    // Alt text
    ".cm-markora-image-alt": {
      color: "#22863a",
      fontStyle: "italic",
    },

    // URL
    ".cm-markora-image-url": {
      color: "#0366d6",
      textDecoration: "underline",
    },

    // Hidden markdown syntax (when cursor is not in range)
    ".cm-markora-image-hidden": {
      display: "none",
    },
