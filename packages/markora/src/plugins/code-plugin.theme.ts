...
export const codePluginTheme = createTheme({
  default: {
    ...
    ".cm-markora-code-line-numbered-diff": {
      ...
      "&.cm-markora-code-line-diff-gutter": {
    ...
    ".cm-markora-code-diff-sign-add": {
      color: "#16a34a",
      fontWeight: "700",
    },

    ".cm-markora-code-diff-sign-del": {
      color: "#dc2626",
      fontWeight: "700",
    },
    ...
    // Text highlight
    ".cm-markora-code-text-highlight": {
      color: "inherit",
