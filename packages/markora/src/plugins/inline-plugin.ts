...
const inlineMarkDecorations = {
  emphasis: Decoration.mark({ class: "cm-markora-emphasis" }),
  strong: Decoration.mark({ class: "cm-markora-strong" }),
  strikethrough: Decoration.mark({ class: "cm-markora-strikethrough" }),
  subscript: Decoration.mark({ class: "cm-markora-subscript" }),
  superscript: Decoration.mark({ class: "cm-markora-superscript" }),
  highlight: Decoration.mark({ class: "cm-markora-highlight" }),
  // Markers (* _ ~~ ^ ~ ==)
...
const theme = createTheme({
  default: {
    ...
    // Strikethrough
    ".cm-markora-strikethrough": {
      textDecoration: "line-through",
      opacity: "0.7",
    },

    // Subscript
    ".cm-markora-subscript": {
      fontSize: "0.75em",
      verticalAlign: "sub",
    },

    // Superscript
    ".cm-markora-superscript": {
      fontSize: "0.75em",
      verticalAlign: "super",
    },

    // Highlight
    ".cm-markora-highlight": {
