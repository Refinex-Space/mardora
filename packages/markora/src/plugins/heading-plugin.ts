...
const headingMarkDecorations = {
  "heading-1": Decoration.mark({ class: "cm-markora-h1" }),
  "heading-2": Decoration.mark({ class: "cm-markora-h2" }),
  "heading-3": Decoration.mark({ class: "cm-markora-h3" }),
  "heading-4": Decoration.mark({ class: "cm-markora-h4" }),
  "heading-5": Decoration.mark({ class: "cm-markora-h5" }),
  "heading-6": Decoration.mark({ class: "cm-markora-h6" }),
  "header-mark-class": Decoration.mark({ class: "cm-markora-header-mark" }),
...
const headingLineDecorations = {
  "heading-1": Decoration.line({ class: "cm-markora-line-h1" }),
  "heading-2": Decoration.line({ class: "cm-markora-line-h2" }),
  "heading-3": Decoration.line({ class: "cm-markora-line-h3" }),
  "heading-4": Decoration.line({ class: "cm-markora-line-h4" }),
  "heading-5": Decoration.line({ class: "cm-markora-line-h5" }),
  "heading-6": Decoration.line({ class: "cm-markora-line-h6" }),
};
...
const theme = createTheme({
  default: {
    ...
    ".cm-markora-line-h3, .cm-markora-line-h4, .cm-markora-line-h5, .cm-markora-line-h6": {
      paddingTop: "1em",
      paddingBottom: "0.5em",
    },
    ".cm-markora-header-mark": {
      opacity: 0.5,
    },
  },
});
