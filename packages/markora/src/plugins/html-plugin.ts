...
const htmlMarkDecorations = {
  "html-tag": Decoration.mark({ class: "cm-markora-html-tag" }),
  "html-comment": Decoration.mark({ class: "cm-markora-html-comment" }),
};
...
const htmlLineDecorations = {
  "html-block": Decoration.line({ class: "cm-markora-line-html-block" }),
  "hidden-line": Decoration.line({ class: "cm-markora-hidden-line" }),
};
...
class HTMLPreviewWidget extends WidgetType {
  ...
  toDOM() {
    ...
    div.className = "cm-markora-html-preview";
...
class InlineHTMLPreviewWidget extends WidgetType {
  ...
  toDOM() {
    ...
    span.className = "cm-markora-inline-html-preview";
...
const theme = createTheme({
  default: {
    ...
    ".cm-markora-html-preview > *:first-child": {
      marginTop: "0",
    },
    ".cm-markora-html-preview > *:last-child": {
      marginBottom: "0",
    },

    ".cm-markora-inline-html-preview": {
      display: "inline",
      whiteSpace: "normal",
    },
  },
