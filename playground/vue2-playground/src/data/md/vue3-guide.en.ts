export default [
  ...
  "",
  "This guide targets Vue 3 projects, with the goal of integrating a Markora editor that matches the Vue 3 playground in quality: rich Markdown editing, source mode, preview mode, HTML/CSS output, plugin toggles, slash commands, attachment uploads, outline, theme switching, and local persistence.",
  "",
  ...
  "",
  "Markora needs no Vue-3-specific component. The recommended approach is to create the CodeMirror `EditorView` inside `onMounted()` and destroy it in `onBeforeUnmount()`.",
  "",
  ...
  "",
  "Vue 3 integration uses Markora's standard API directly:",
  "",
