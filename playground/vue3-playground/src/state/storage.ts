...
export const STORAGE_CONTENTS_KEY = "mardora-vue3-playground-contents";
export const STORAGE_CURRENT_KEY = "mardora-vue3-playground-current";
export const STORAGE_VERSION_KEY = "mardora-vue3-playground-version";
