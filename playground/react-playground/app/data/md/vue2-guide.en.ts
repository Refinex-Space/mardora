export default [
  ...
  "",
  "This guide targets Vue 2 projects, with the goal of integrating a Mardora editor that matches the Vue 2 playground in quality: rich Markdown editing, source mode, preview mode, HTML/CSS output, plugin toggles, slash commands, attachment uploads, outline, theme switching, and local persistence.",
  "",
  ...
  "",
  "Vue 2 projects typically also need TypeScript, the Vue 2 loader, and the bundler's own configuration. Mardora requires no Vue-2-specific adapter; you use the CodeMirror `EditorView` directly.",
  "",
  ...
  "",
  "```ts",
  "function jumpToc(this: Vue & any, item: MardoraTocItem) {",
  '  if (this.mode === "view") {',
  ...
  "",
  "Vue 2 integration does not require working around Mardora's standard API. Use directly:",
  "",
  ...
  "",
  "If you want custom syntax, create a `MardoraPlugin` and provide `getMarkdownConfig()`; for custom edit-state visuals, provide `buildDecorations()`; to keep preview in sync, provide `renderToHTML()` and `getPreviewStyles()`.",
  "",
