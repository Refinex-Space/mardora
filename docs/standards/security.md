...
Markora core provides upload hooks and formatting. It must not own production storage, signing, OSS/S3 SDKs, or backend credentials unless the public API boundary is intentionally changed.
...
Security reports should use GitHub private vulnerability reporting for `Refinex-Space/markora` rather than public issue details.
